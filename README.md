...
If ordering from JLC, you can also have JLC assemble a large part of the build for you, simplifying sourcing much of the BOM. If you choose to use PCBA, you will still need to solder:
